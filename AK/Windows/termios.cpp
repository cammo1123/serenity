...
DCB SerialParams = { .BaudRate = 0 };
struct COM com;
COMMTIMEOUTS timeouts = { .ReadTotalTimeoutMultiplier = 0 };
...
int tcgetattr(int fd, [[maybe_unused]] struct termios* termios_p) {
...
int tcsetattr(int fd, [[maybe_unused]] int optional_actions, const struct termios* termios_p) {
  ...
  [[maybe_unused]] tcflag_t oflag = termios_p->c_oflag;
  ...
  //lflag
  [[maybe_unused]] int EchoOpt = getEchoOptions(lflag);
  [[maybe_unused]] int l_opt = getLocalOptions(lflag);
  [[maybe_unused]] int tostop = getToStop(lflag);
...
int tcsendbreak(int fd, [[maybe_unused]] int duration) {
...
void cfmakeraw([[maybe_unused]] struct termios* termios_p) {
...
speed_t cfgetispeed([[maybe_unused]] const struct termios* termios_p) {

  return SerialParams.BaudRate;
}

speed_t cfgetospeed([[maybe_unused]] const struct termios* termios_p) {

  return SerialParams.BaudRate;
}

int cfsetispeed([[maybe_unused]] struct termios* termios_p, speed_t speed) {

  SerialParams.BaudRate = speed;
  return 0;
}

int cfsetospeed([[maybe_unused]] struct termios* termios_p, speed_t speed) {

  SerialParams.BaudRate = speed;
  return 0;
}

int cfsetspeed([[maybe_unused]] struct termios* termios_p, speed_t speed) {
...
int close_serial([[maybe_unused]] int fd) {
...
int select_serial([[maybe_unused]] int nfds, fd_set* readfds, [[maybe_unused]] fd_set* writefds, [[maybe_unused]] fd_set* exceptfds, [[maybe_unused]] struct timeval* timeout) {
  ...
  if (dwEventMask == EV_RXCHAR) {
    ...
    if (readfds) {
      ...
      FD_CLR((unsigned long) com.fd, readfds);
    }
  }
