...
File::~File() {
	dbgln("File: ~File not implemented");
	VERIFY_NOT_REACHED();
}

ErrorOr<NonnullRefPtr<File>> File::open(DeprecatedString, OpenMode, mode_t) {
...
bool File::is_directory() const {
	dbgln("File: is_directory not implemented");
	VERIFY_NOT_REACHED();
}
bool File::is_directory(DeprecatedString const&) {
	dbgln("File: is_directory not implemented");
	VERIFY_NOT_REACHED();
}
bool File::is_directory(int) {
	dbgln("File: is_directory not implemented");
	VERIFY_NOT_REACHED();
}
...
bool File::exists(StringView) {
	dbgln("File: exists not implemented");
	VERIFY_NOT_REACHED();
}
...
DeprecatedString File::real_path_for(DeprecatedString const&) {
	dbgln("File: real_path_for not implemented");
	VERIFY_NOT_REACHED();
}
...
bool File::open(OpenMode) {
	dbgln("File: open not implemented");
	VERIFY_NOT_REACHED();
}

bool File::open(int, OpenMode, ShouldCloseFileDescriptor) {
	dbgln("File: open not implemented");
	VERIFY_NOT_REACHED();
}
